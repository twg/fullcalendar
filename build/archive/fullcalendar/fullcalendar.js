/*!
 * FullCalendar v1.6.4 (TWG Customized)
...
var fc = $.fullCalendar = { version: "1.6.4 (TWG Customized)" };
...
function ListView(element, calendar, viewName) {
	...
	function buildHeadHTML() {
		...
		for (col=0; col<colCnt; col++) {
			date = cellToDate(0, col);
			html +=
				"<th class='fc-day-header fc-" + dayIDs[date.getDay()] + " " + headerClass + "'> Week of " +
				htmlEscape(formatDate(date, colFormat)) +
				"</th>";
		}
	...
	function buildCellHTML(date) {
		...
		html +=
			"<div class='fc-inner-day-header fc-" + dayIDs[date.getDay()] + " '>" +
			htmlEscape(formatDate(date, 'dddd, MMM d')) +
			"</div>";
...
/*************************************************************
  ************************************************************
  ...
  ---- TODO: Try not to have to redefine all these. ----------
	------------------------------------------------------------
	-----------------------------------------------------------*/
